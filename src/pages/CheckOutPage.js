...
import tabImg1 from '../../assets/check-out.png';
import HeaderDrawer from '../components/HeaderDrawer'

const text = "Checkout Here";

export default class CheckOutPage extends Component {
    render() {
        return (
            <View>
                <HeaderDrawer title = "Check Out"/>
                <ScrollView>
                <View style={styles.scene} >
                   
                        <View style={styles.ImageCover}>
                            <Image source={tabImg1} style={styles.tabImg} resizeMode="contain" />
                            <Text style={styles.ImageText}>Check Out</Text>
                        </View>
                ...
                <View style={styles.SendMsgBtnCover}>
                            <TouchableOpacity style={styles.SPTO}
                                ...
                                <LoginButton buttonText={"Check Out"} />
                            </TouchableOpacity>
                            <Toast ref="toast"
